...
{
    /// <summary>
    /// <see cref="TextLineProcessor"/> クラスの単体テストです。
    /// </summary>
    [TestClass]
    public class TextLineProcessorTest
    {
        /// <summary>
        /// <see cref="TextLineProcessor.Process"/> のマクロ命令の展開の確認。
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// <see cref="TextLineProcessor.Process"/> のリテラルの DC 命令生成の確認。
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// <see cref="TextLineProcessor.Process"/> で、
        ...
        /// <summary>
        /// <see cref="TextLineProcessor.Process"/> で、重複したラベルが定義されている場合。
        /// </summary>
        [TestMethod]
